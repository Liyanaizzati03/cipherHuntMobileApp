                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'if3naoy6' /* Fill out the information below... */,
                                  ),
                                  textAlign: TextAlign.center,
                                  style: FlutterFlowTheme.of(context)
                                      .labelMedium
                              ...
                              Padding(
                                ...
                                child: Container(
                                  width: double.infinity,
                                  child: TextFormField(
                                    key: ValueKey('emailAddress_ed5o'),
                                    controller:
                                      ...
                                      children: [
                                        TextSpan(
                                          text: FFLocalizations.of(context)
                                              .getText(
                                            '53x52sel' /* Don't have an account?   */,
                                          ),
                                          style: TextStyle(),
                                        ),
                                        TextSpan(
