...
import 'vigenerelevel3_model.dart';
export 'vigenerelevel3_model.dart';

class Vigenerelevel3Widget extends StatefulWidget {
  const Vigenerelevel3Widget({
    super.key,
  ...
  static String routeName = 'vigenerelevel3';
  static String routePath = '/vigenerelevel3';

  @override
  State<Vigenerelevel3Widget> createState() => _Vigenerelevel3WidgetState();
}

class _Vigenerelevel3WidgetState extends State<Vigenerelevel3Widget>
    with TickerProviderStateMixin {
  late Vigenerelevel3Model _model;
        ...
        appBar: AppBar(
          ...
          title: Text(
            FFLocalizations.of(context).getText(
              'xtby5azt' /* Vigenere Cipher - Level 3 */,
            ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: EdgeInsets.all(12.0),
                                      child: Text(
                                        'Encrypt the phrase \"FOOD DELIVERY SERVICE\" using the keyword \"LUNCH\".',
                                    ...
                                    Expanded(
                                      child: Align(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'oz2mxtwx' /* Try ENCYPT this message:
FOOD ... */
                                              ,
                                            ),
                                            textAlign: TextAlign.center,
                          ...
                          children: [
                            Padding(
                              ...
                              child: FFButtonWidget(
                                ...
                                text: FFLocalizations.of(context).getText(
                                  'jia88y5e' /* QSBF KPFVXLCS FGYGCPH */,
                                ),
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                ...
                                text: FFLocalizations.of(context).getText(
                                  'ai7v7se0' /* QSBF KPFVXLCR FGYGCPS */,
                                ),
                                options: FFButtonOptions(
                                  height: 40.0,
                                  padding: EdgeInsetsDirectional.fromSTEB(
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                ...
                                text: FFLocalizations.of(context).getText(
                                  '3ybd8mim' /* QSBF KPFVXLCR FGYGCPG */,
                                ),
                                options: FFButtonOptions(
                                  height: 41.24,
                                  padding: EdgeInsetsDirectional.fromSTEB(
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                ...
                                text: FFLocalizations.of(context).getText(
                                  'xmvbdu8t' /* QSBF KPFVXLCS FGYGCPG  */,
                                ),
                                options: FFButtonOptions(
                                  height: 40.0,
                                  padding: EdgeInsetsDirectional.fromSTEB(
                          ...
                          await showDialog(
                            ...
                            builder: (alertDialogContext) {
                              return AlertDialog(
                                title: Text('🧠 Hint:'),
                                content: Text(
                                    'Repeat LUNCH across all letters.First word starts with Q, and the last ends with G. 🍽️'),
                                actions: [
                                  TextButton(
                                    onPressed: () =>
