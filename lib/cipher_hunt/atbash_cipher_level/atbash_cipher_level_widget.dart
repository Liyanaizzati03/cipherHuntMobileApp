...
import 'atbash_cipher_level_model.dart';
export 'atbash_cipher_level_model.dart';

class AtbashCipherLevelWidget extends StatefulWidget {
  const AtbashCipherLevelWidget({super.key});

  static String routeName = 'AtbashCipherLevel';
  static String routePath = '/AtbashCipher';

  @override
  State<AtbashCipherLevelWidget> createState() =>
      _AtbashCipherLevelWidgetState();
}

class _AtbashCipherLevelWidgetState extends State<AtbashCipherLevelWidget> {
  late AtbashCipherLevelModel _model;
