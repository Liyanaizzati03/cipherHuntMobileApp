                    ...
                    await showDialog(
                      ...
                      builder: (alertDialogContext) {
                        return AlertDialog(
                          title: Text('🧠 Hint:'),
                          content: Text(
                              'Use your reversed alphabet table to find each mirrored letter.The first word becomes HGZB, and the last one starts with U.It’s the kind of message you’d send from one fighter to another. 💪'),
                          actions: [
                            TextButton(
                              onPressed: () =>
                                  Navigator.pop(alertDialogContext),
