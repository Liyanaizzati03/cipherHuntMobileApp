...
import 'confetti_winner_page_v5_model.dart';
export 'confetti_winner_page_v5_model.dart';

class ConfettiWinnerPageV5Widget extends StatefulWidget {
  const ConfettiWinnerPageV5Widget({
    super.key,
  ...
  static String routeName = 'ConfettiWinnerPageV5';
  static String routePath = '/ConfettiWinnerPageV5';

  @override
  State<ConfettiWinnerPageV5Widget> createState() =>
      _ConfettiWinnerPageV5WidgetState();
}

class _ConfettiWinnerPageV5WidgetState extends State<ConfettiWinnerPageV5Widget>
    with TickerProviderStateMixin {
  late ConfettiWinnerPageV5Model _model;
                        ...
                        children: [
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'vh1k61b9' /* Level 5 : Vigenère Cipher Solv... */,
                                    ),
                                ...
                                Expanded(
                                  child: Align(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        '3g19irn1' /* NEVER STOP DREAMING ➝ ZEBMT ET... */,
                                      ),
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'gftfve27' /* 💡 Beat by Brains! It stayed u... */,
                                ),
                                textAlign: TextAlign.center,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
