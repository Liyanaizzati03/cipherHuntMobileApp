...
import 'vigenerelevel1_model.dart';
export 'vigenerelevel1_model.dart';

class Vigenerelevel1Widget extends StatefulWidget {
  const Vigenerelevel1Widget({
    super.key,
  ...
  static String routeName = 'vigenerelevel1';
  static String routePath = '/vigenerelevel1';

  @override
  State<Vigenerelevel1Widget> createState() => _Vigenerelevel1WidgetState();
}

class _Vigenerelevel1WidgetState extends State<Vigenerelevel1Widget>
    with TickerProviderStateMixin {
  late Vigenerelevel1Model _model;
          ...
          flexibleSpace: FlexibleSpaceBar(
            title: Text(
              FFLocalizations.of(context).getText(
                '3h60o9md' /* Vigenere Cipher - Level 1 */,
              ),
                            ...
                            child: Column(
                              ...
                              children: [
                                Expanded(
                                  child: Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          '73684m3g' /* WELCOME TO FIRST CHALLENGE!! */,
                                        ),
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    'A Vigenère Cipher shifts each letter in a message by varying amounts based on a keyword. For example, with the keyword \"KEY\", A might become K, B might become F, and so on.',
                                        ...
                                        await Navigator.push(
                                          ...
                                          PageTransition(
                                            ...
                                            child: FlutterFlowExpandedImageView(
                                              image: Image.asset(
                                                'assets/images/after_the_shift_happens_to_all_letter_(6).gif',
                                                fit: BoxFit.contain,
                                              ),
                                              allowRotation: true,
                                              tag: 'imageTag',
                                ...
                                Expanded(
                                  child: Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          'dkkqcere' /* Try Encrypt this message: 
COM... */
                                          ,
                                        ),
                                        textAlign: TextAlign.center,
                    ...
                    await showDialog(
                      ...
                      builder: (alertDialogContext) {
                        return AlertDialog(
                          title: Text('🧠 Hint:'),
                          content: Text(
                              'Repeat the keyword to match the message.First letter becomes M, last letter is V.'),
                          actions: [
                            TextButton(
                              onPressed: () =>
                                  Navigator.pop(alertDialogContext),
