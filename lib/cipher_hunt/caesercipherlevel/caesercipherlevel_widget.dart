...
class CaesercipherlevelWidget extends StatefulWidget {
  ...
  static String routeName = 'caesercipherlevel';
  static String routePath = '/caesercipher';

  @override
  State<CaesercipherlevelWidget> createState() =>
      _CaesercipherlevelWidgetState();
}

class _CaesercipherlevelWidgetState extends State<CaesercipherlevelWidget> {
  late CaesercipherlevelModel _model;
