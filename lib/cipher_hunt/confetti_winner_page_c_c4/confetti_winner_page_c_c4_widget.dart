...
class _ConfettiWinnerPageCC4WidgetState
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ConfettiWinnerPageCC4'});
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Align(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'gqdi4xrh' /* DATA SECURITY ➝ IFYF XJFWYD
Yo... */
                                        ,
                                      ),
                                      textAlign: TextAlign.center,
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'qens5665' /* 📜 Wrap Around! The Caesar Cip... */,
                                ),
                                textAlign: TextAlign.center,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                  ...
                  child: Row(
                    ...
                    children: [
                      FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'CONFETTI_WINNER_C_C4_REPLAY_LEVEL_BTN_ON');
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'CONFETTI_WINNER_C_C4_MAIN_MENU_BTN_ON_TA');
                          logFirebaseEvent('Button_navigate_to');
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'CONFETTI_WINNER_C_C4_NEXT_LEVEL_BTN_ON_T');
                          logFirebaseEvent('Button_navigate_to');
